...
# (array([0, 1, 2, 3, 4, 5, 6]), array([158880, 212476,  26816,   2060,   7120,  13025,  15382]))
################## SMOTE 적용 ####################
...
print(np.unique(y_train,return_counts=True))
# (array([0, 1, 2, 3, 4, 5, 6]), array([212476, 212476, 212476, 212476, 212476, 212476, 212476]))
print(x_train.shape)    #(1487332, 54)
# exit()
